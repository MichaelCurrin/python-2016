...
adwords_accounts = [
    dict(name="XXXX", id="XXX-XXX-XXX", title="XXX")
    # ...
    # ...
    # ...
]
...
START_DATE, END_DATE = GetMonthToDate(end_offset_days=-2, out_format=OUT_FORMAT)

# The past 3 months from 1st of month up to yesteday.
START_DATE_ALT, END_DATE_ALT = GetMonthToDate(
    end_offset_days=-1, start_offset_months=-2, out_format=OUT_FORMAT
)
